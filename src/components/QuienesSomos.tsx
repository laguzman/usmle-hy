...
import { quienesSomosText, quienesSomosQuote, quienesSomosCeo, gallerySections } from "@/lib/data";

const equipoSection = gallerySections.find((s) => s.key === "equipo")!;
    ...
    <section className="relative pt-40 pb-28">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <Reveal delay={0.1} className="mx-auto mt-16 max-w-3xl">
          ...
          >
            <h3 className="font-display text-xl font-bold text-ink">{equipoSection.title}</h3>
            <p className="mt-3 text-sm leading-relaxed text-ink-muted">
              {equipoSection.description}
            </p>
